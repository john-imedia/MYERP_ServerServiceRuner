            ...
            try
            {
                ...
                if (w != DayOfWeek.Sunday)  //工作日发
                {
                    if (h == 7)
                    {
                        ...
                        else if (m == 55 && s == 10) //每天零点发送昨天工单差异数
                        {
...
";
                ...
                DateTime bTime = DateTime.Now;
                string SQL = @"EXEC [_PMC_Progress_List_New] NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,@DiffFlag,NULL,NULL,@StockStatus,NULL,NULL,NULL";
                MyData.MyDataTable md = new MyData.MyDataTable(SQL, mps);
